...
/**
 */
public class BackPressImpl implements OnFragmentBackListener {
    ...
    public boolean onBackPressed() {
        ...
        if (childCount == 0) {
            ...
            OnFragmentBackListener childFragment = (OnFragmentBackListener) childFragmentManager.getFragments().get(0);
