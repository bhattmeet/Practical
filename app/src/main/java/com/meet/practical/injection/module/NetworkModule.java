...
import com.meet.practical.BuildConfig;
import com.meet.practical.Practical;
import com.meet.practical.model.entity.response.User;
import com.meet.practical.network.RxErrorHandlingCallAdapterFactory;
...
public class NetworkModule {
    ...
    OkHttpClient provideOkHttpClient() {
        ...
        builder.addInterceptor(chain -> {
            ...
            try{
                User userInfo = AppUtils.getUserPrefrence(Practical.getContext());
                ...
                Log.e("Exception" ,"provideOkHttpClient: "+e.getMessage());
            }
