...
public class ValidationUtil {
    ...
    public static boolean checkMinTextValidationPassword(String text, int textLength) {
        if (StringHelper.isEmpty(text)) {
            return false;
        } else return text.trim().length() >= textLength;
    }

    public static boolean checkMaxTextValidationPassword(String text, int textLength) {
        if (StringHelper.isEmptyPassword(text)) {
            return false;
        } else return text.trim().length() <= textLength;
    }
