...
package com.meet.owlutilities.otpVerification;
...
class SmsReceiver extends BroadcastReceiver {
     ...
     */
    public void setCallback(OnSmsCatchListener<String> callback ,String smsGateWayCode) {
        ...
        try {
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    if(phoneNumber.equalsIgnoreCase(smsGateWayCode)) {
